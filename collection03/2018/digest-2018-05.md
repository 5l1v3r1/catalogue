...
<blockquote>
StaCoAn is a crossplatform tool which aids developers, bugbounty hunters and ethical hackers performing static code analysis on mobile applications. - GitHub - vincentcox/StaCoAn: StaCoAn is a cros...
</blockquote>
</td></tr></table>
...
<blockquote>
A Static Analysis Tool for Detecting Security Vulnerabilities in Python Web Applications - GitHub - python-security/pyt: A Static Analysis Tool for Detecting Security Vulnerabilities in Python Web ...
</blockquote>
</td></tr></table>
...
Crackme: http://crackmes.cf/archive/
...
<blockquote>
A list of open source reverse engineering tools with a focus on binary analysis - GitHub - extremecoders-re/re-list: A list of open source reverse engineering tools with a focus on binary analysis
</blockquote>
</td></tr></table>
...
<blockquote>
💬 Instant messaging server for the Extensible Messaging and Presence Protocol (XMPP). - GitHub - ortuman/jackal: 💬 Instant messaging server for the Extensible Messaging and Presence Protocol (XMPP).
</blockquote>
</td></tr></table>
...
<blockquote>
An IDA Pro plugin to examine the glibc heap, focused on exploit development - GitHub - danigargu/heap-viewer: An IDA Pro plugin to examine the glibc heap, focused on exploit development
</blockquote>
</td></tr></table>
