...
<blockquote>
A fully implemented kernel exploit for the PS4 on 4.05FW - GitHub - Cryptogenic/PS4-4.05-Kernel-Exploit: A fully implemented kernel exploit for the PS4 on 4.05FW
</blockquote>
</td></tr></table>
...
<blockquote>
Framework for building Windows malware, written in C++ - GitHub - richkmeli/Richkware: Framework for building Windows malware, written in C++
</blockquote>
</td></tr></table>
...
<blockquote>
GUI tool to create ROP chains using the ropper API - GitHub - orppra/ropa: GUI tool to create ROP chains using the ropper API
</blockquote>
</td></tr></table>
...
<blockquote>
idahunt is a framework to analyze binaries with IDA Pro and hunt for things in IDA Pro - GitHub - nccgroup/idahunt: idahunt is a framework to analyze binaries with IDA Pro and hunt for things in ID...
</blockquote>
</td></tr></table>
...
<blockquote>
An analysis of the Warbird virtual-machine protection for the CI!g_pStore - GitHub - airbus-seclab/warbirdvm: An analysis of the Warbird virtual-machine protection for the CI!g_pStore
</blockquote>
</td></tr></table>
